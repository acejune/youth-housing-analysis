...
def process_living_population_dong_code():
    ...
    lp_name2code_save_path = utils.check_path('생활인구',
                                              '생활인구_행정동_코드.json')
    ...
    lp_hcode2scode_save_path = utils.check_path('생활인구',
                                                '생활인구_행정동_코드_h2s.json')
...
def process_living_population_data():
    ...
    # 필요한 column만 남기기
    df = df[['기준일ID', '시간대구분', '행정동코드',
             '남자20세부터24세생활인구수', '남자25세부터29세생활인구수', '남자30세부터34세생활인구수', 
             '여자20세부터24세생활인구수', '여자25세부터29세생활인구수', '여자30세부터34세생활인구수']]

    # column 이름 바꾸기
    df.columns = ['date', 'time', 'dong_code',
                  'man_20_24_pop', 'man_25_29_pop', 'man_30_34_pop',
                  'woman_20_24_pop', 'woman_25_29_pop', 'woman_30_34_pop']
    ...
    df = df[['date', 'time', 'dong_name', 'dong_code',
             'man_20_24_pop', 'man_25_29_pop', 'man_30_34_pop',
             'woman_20_24_pop', 'woman_25_29_pop', 'woman_30_34_pop']]
...
def sum_living_population_by_dong():
    ...
    # 행정동 데이터 분석
    dong_df = df.groupby(['dong_name', 'dong_code']).agg({'man_20_24_pop': 'sum',
                                                          'man_25_29_pop': 'sum',
                                                          'man_30_34_pop': 'sum',
                                                          'woman_20_24_pop': 'sum',
                                                          'woman_25_29_pop': 'sum',
    ...
    dong_df['pop_sum'] = dong_df[['man_20_24_pop', 'man_25_29_pop', 'man_30_34_pop',
                                  'woman_20_24_pop', 'woman_25_29_pop', 'woman_30_34_pop']].sum(axis=1)
    dong_df = dong_df[['dong_name', 'dong_code', 'pop_sum']]
    dong_df_save_path = utils.check_path('생활인구',
                                         '생활인구_분석_행정동별_청년_생활인구_합.csv')
...
def visualize_living_population_by_dong():
    ...
    # 시각화
    df['dong_code'] = df['dong_code'].apply(str)
    utils_vis.visualize_by_dong(df=df,
